...
public class MainClass {
	...
	public static void main(String[] args) {
		 ...
		 */
		 ...
		 cal.add(10);
		 System.out.println("계산기로 원의넓이:" + cal.circle(3) );
		 
		 
		 Computer com = new Computer();
		 com.add(10);
		 System.out.println("컴퓨터로 원의넓이:" + com.circle(3) );
		 
		 System.out.println("사각형의 넓이:" + com.rect(3) );
		 System.out.println("직사각형의 넓이:" + com.rect(3,3 ) );
